...
do_action('arm_aff_summery_export', $_REQUEST);
    ...
    function arm_load_visits_grid(is_filtered, message) {
        ...
        var dt_obj = {
            "oLanguage": {
                ...
                "sEmptyTable": "No any summery found.",
                "sZeroRecords": "No matching summery found."
            },
            "bProcessing": false,
            "bServerSide": true,
            ...
            "fnServerParams": function (aoData) {
                aoData.push({'name': 'action', 'value': 'arm_summery_list'});
...
<div class="arm_members_list">
        <form name='export_data_to_csv' id='export_data_to_csv' method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="arm_action" id="arm_action" value="summery_export_csv"/>
        </form>
        <form method="POST" id="arm_summery_list_form" class="data_grid_list" enctype="multipart/form-data">
