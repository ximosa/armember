...
use Motopress_Demo;
use motopress_demo\classes\libs\GUMP;
...
class Preprocessor extends GUMP {
	...
	static function install() {
		Core::include_all(Motopress_Demo::get_plugin_part_path('classes/preprocessors/'));
	}
	...
	public function call_controller($action = 'content', $page = false) {
		...
		$path = Motopress_Demo::get_plugin_part_path('classes/controllers/');
