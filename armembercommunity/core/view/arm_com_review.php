<?php global $wpdb, $arm_community_setting, $arm_global_settings, $arm_version; ?>
<div class="wrap arm_page arm_manage_members_main_wrapper">
	<div class="content_wrapper" id="content_wrapper">
		<?php echo $arm_community_setting->arm_get_community_user_activity_tab('arm_com_review_selected'); ?>
		<div class="arm_members_grid_container" id="arm_members_grid_container">
			<?php
				if (file_exists(ARM_COMMUNITY_VIEW_DIR . '/arm_com_review_list_records.php')) {
					include( ARM_COMMUNITY_VIEW_DIR . '/arm_com_review_list_records.php');
				}
			?>
		</div>
        ...
        $bulk_delete_post_popup_content = '<span class="arm_confirm_text">' . __("Are you sure you want to delete this Review(s)?", ARM_COMMUNITY_TEXTDOMAIN);
        ...
        $bulk_delete_post_popup_arg = array(
            ...
            'title' => __('Delete Review(s)', ARM_COMMUNITY_TEXTDOMAIN),
            'content' => $bulk_delete_post_popup_content,
            'button_id' => 'arm_bulk_delete_review_ok_btn',
            'button_onclick' => "apply_com_review_bulk_action('bulk_delete_flag');",
        );
